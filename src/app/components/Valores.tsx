...
<div id="valores" className="max-w-7xl mx-auto px-4 lg:px-8 py-5 lg:py-20 grid md:grid-cols-4 md:gap-5 lg:gap-8 gap-3 items-start justify-center ">


    <div className="flex flex-col items-center justify-center max-w-sm p-2 gap-1 text-emerald-500">
